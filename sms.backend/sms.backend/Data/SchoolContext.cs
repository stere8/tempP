...
namespace sms.backend.Data
{
    public class SchoolContext : IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configure StudentParent -> Student relationship
            modelBuilder.Entity<StudentParent>()
            ...
            // Configure Student to IdentityUser relationship
            modelBuilder.Entity<Student>()
                .HasOne(s => s.User)
                .WithMany()
                .HasForeignKey(s => s.UserId);

            // Configure Staff to IdentityUser relationship
            modelBuilder.Entity<Staff>()
                .HasOne(s => s.User)
                .WithMany()
                .HasForeignKey(s => s.UserId);

            // Configure Parent to IdentityUser relationship
            // This links the Parent entity's UserId (string) to AspNetUsers.Id.
            modelBuilder.Entity<Parent>()
                .HasOne(p => p.User)
                .WithMany() // Adjust if you extend IdentityUser with a collection of Parents.
